...
class JMethodDeclaration extends JAST implements JMember {
	...
	/** Throw types **/
	protected ArrayList<Type> throwTypes;
...

	{
		...
		this.throwTypes = new ArrayList<Type>();
		this.params = params;
		this.body = body;
	...
	public JMethodDeclaration(int line, ArrayList<String> mods, String name, Type returnType,
			ArrayList<Type> throwTypes, ArrayList<JFormalParameter> params, JBlock body)
	...
	public void preAnalyze(Context context, CLEmitter partial) {
		...
		for (int i = 0; i < throwTypes.size(); i++)
			throwTypes.set(i, throwTypes.get(i).resolve(context));
